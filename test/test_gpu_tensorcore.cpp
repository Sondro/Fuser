...
TEST_F(NVFuserTest, FusionMatmulSegmenter_BasicMatmul_StrictCheck_TT_CUDA) {
  NVFUSER_TEST_CUDA_ARCH_GUARD(8, 0);
...
TEST_F(NVFuserTest, FusionMatmulSegmenter_BasicMatmul_RelaxedCheck_CUDA) {
  NVFUSER_TEST_CUDA_ARCH_GUARD(8, 0);
  ...
  for (auto layout : kAllSupportedMatmulLayout) {
    ...
    at::Tensor tref = atMatmul(t0, t1, at::kFloat, layout);
